...
private fun AuthTestSection(
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            // Login fields
            Text(text = stringResource(R.string.api_test_login_subtitle), style = MaterialTheme.typography.labelLarge)
            OutlinedTextField(
                value = username,
            ...
            // Register fields
            Text(text = stringResource(R.string.api_test_register_subtitle), style = MaterialTheme.typography.labelLarge)
            OutlinedTextField(
                value = email,
        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Row(
                ...
                TextButton(onClick = onClear) {
                    Text(stringResource(R.string.api_test_clear_button))
                }
            }
