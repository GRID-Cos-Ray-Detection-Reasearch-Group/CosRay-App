                                                        ...
                                                        Text(
                                                                text =
                                                                        state.device?.let {
                                                                                ...
                                                                                stringResource(
                                                                                        R.string
                                                                                                .dashboard_device_connected,
                                                                                        name
                                                                                )
                                                                        }
                                                                                ?: stringResource(
                                                                                        R.string
                                                                                                .dashboard_device_disconnected
                                                                                ),
                                                                style =
                                                                        MaterialTheme.typography
                                                                                .bodyMedium,
                        ...
                        Surface(
                                ...
                                LazyColumn(
                                        ...
                                        if (state.samples.isEmpty()) {
                                                ...
                                                items(state.samples) { sample ->
                                                        TelemetryCard(sample)
                                                }
                                        }
                                }
                        }
        ...
        Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                Text(
                        text = state.user?.displayName
                                        ?: stringResource(R.string.dashboard_title_default),
                        ...
                        MetricRow(
                                ...
                                value =
                                        sample.environment.primaryTemperatureCelsius?.let {
                                                stringResource(
                                                        R.string.dashboard_temperature_value,
                                                        it
                                                )
                                        }
                                                ?: "--"
