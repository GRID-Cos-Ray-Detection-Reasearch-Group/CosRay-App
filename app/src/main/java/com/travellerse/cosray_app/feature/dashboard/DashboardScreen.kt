...
@Composable
fun DashboardScreen(state: DashboardUiState, onUpload: () -> Unit, onMessageShown: () -> Unit) {
                        ...
                        Text(
                                text =
                                        state.device?.let {
                                            ...
                                            stringResource(
                                                    R.string.dashboard_device_connected,
                                                    name
                                            )
                                        }
                                                ?: stringResource(
                                                        R.string.dashboard_device_disconnected
                                                ),
                    ...
                    Button(onClick = onUpload, enabled = !state.isUploading) {
                        Text(
                                text =
                                        ...
                                        else stringResource(R.string.dashboard_upload)
                        )
                    }
                }
                ...
                Box(modifier = Modifier.fillMaxWidth().padding(top = 4.dp, bottom = 4.dp)) {
                    Text(
                            text =
                                    ...
                                    else stringResource(R.string.dashboard_live_data),
            ...
            MetricRow(
                    ...
                    value =
                            sample.power.batteryPercent?.let {
                                stringResource(R.string.dashboard_battery_value, it)
                            }
                                    ?: "--"
            )
        }
