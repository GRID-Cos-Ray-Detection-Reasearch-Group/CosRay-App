...
fun LoginScreen(
    ...
    Column(
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            Text(
                    text =
                            if (isRegistering) stringResource(R.string.auth_register_title)
        ...
        Surface(
            ...
            Column(
                ...
                val primaryFieldLabel =
                        if (isRegistering) R.string.auth_email_label
                        else R.string.auth_username_label
                    ...
                    if (state.isLoading) {
                        ...
                        Text(
                                text =
                                        ...
                                        else stringResource(R.string.auth_login_action),
                                style = MaterialTheme.typography.bodyMedium
                        )
                    }
                }
        ...
        TextButton(
            ...
            Text(
                    text =
                            if (isRegistering) stringResource(R.string.auth_have_account_action)
