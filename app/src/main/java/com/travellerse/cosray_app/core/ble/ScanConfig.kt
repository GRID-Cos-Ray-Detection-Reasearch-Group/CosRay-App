...
data class ScanConfig(
        ...
        /**
         * Minimum RSSI threshold in dBm (-127 to 0) Devices with weaker signal will be filtered out
         */
        ...
        /** Only return devices that are connectable */
    ...
    companion object {
        ...
        val LowPower =
                ScanConfig(scanMode = ScanSettings.SCAN_MODE_LOW_POWER, scanDuration = 15_000L)

        /** Balanced scan mode */
        val Balanced =
                ScanConfig(scanMode = ScanSettings.SCAN_MODE_BALANCED, scanDuration = 12_000L)
