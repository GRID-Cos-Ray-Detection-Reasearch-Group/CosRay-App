...
object Protocol {
    ...
    data class MuonDataPkg(
        ...
        companion object {
            ...
            private val HEAD_EXPECTED =
                    byteArrayOf(0xAA.toByte(), 0xBB.toByte(), 0xCC.toByte()) // 预期头部标识
            private val TAIL_EXPECTED =
                    byteArrayOf(0xDD.toByte(), 0xEE.toByte(), 0xFF.toByte()) // 预期尾部标识
    ...
    data class TimeLinePkg(
        ...
        companion object {
            ...
            private val TAIL_EXPECTED =
                    byteArrayOf(0x78.toByte(), 0x9A.toByte(), 0xBC.toByte()) // 预期尾部标识
